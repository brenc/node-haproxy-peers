...
import d from "debug";
import type { StickTableStore } from "./aggregator";
import {
	DictionaryEncoder,
	encodeAck,
...
import type { EntryUpdate, TableDefinition } from "./types";
import {
	ControlMessageClass,
 ...
 */
// biome-ignore lint/suspicious/noUnsafeDeclarationMerging: interface provides typed event overloads for the EventEmitter subclass
